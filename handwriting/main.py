...
class FilePaths:
    ...
    fn_char_list = 'handwriting/charList.txt'
    fn_summary = 'handwriting/summary.json'
    fn_corpus = 'handwriting/corpus.txt'
...
def infer(model: Model, fn_img: Path) -> None:
    ...
    print(f'Recognized6759347634567835768345678534267854:{recognized[0]}')
